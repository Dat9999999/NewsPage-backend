...
namespace NewsPage.Migrations
{
    ...
    [Migration("20250406051149_BannerCampaignRelationShip")]
    partial class BannerCampaignRelationShip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BannerCampaign", b =>
                {
                    ...
                    b.Property<Guid>("TargetAutidienceId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("AdvertisorId")
                        .IsUnique();

                    b.HasIndex("TargetAutidienceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BannerCampaign", b =>
                {
                    b.HasOne("NewsPage.Models.entities.UserAccounts", null)
                        .WithOne()
                        .HasForeignKey("BannerCampaign", "AdvertisorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BannerAudience", null)
                        .WithOne()
                        .HasForeignKey("BannerCampaign", "TargetAutidienceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
